...
async function renderEpisodes(){
    ...
    users.forEach(episode => {
        ...
        <picture>
            ...
            <img class="b-lazy preview-banner" loading="lazy" src="${episode.image}" alt="A ti, 2,000 años en el futuro. La caída de Shiganshina - Primera Parte" data-t="card-image">
        </picture>
        <div style="width: 100%;">
        ...
        console.log("Contenido insertado en la página");
        htmlContent += htmlSegment;
        
    });

    let container = document.getElementsByClassName('chapter-list');
